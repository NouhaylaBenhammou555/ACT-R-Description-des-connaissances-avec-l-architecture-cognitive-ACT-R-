;*****************************
;Benhammou Nouhayla (benn1403) 
;Derfoufi Asmae (dera1504) 
;L'Hassnaoui Kaoutar (lhak0901)
;*****************************
...
(sgp :v nil :esc t :lf 0.4 :bll 0.5 :ans 0.4 :rt 1.25 :ncnar nil :act t)

;for perfect remember 
;(sgp :v t :ncnar nil)
...
(add-dm
 ...
 (goal isa goal)
 (attending) (count) (counting)(try-remember) (testing))
...
(p remember
  ...
  ==>
    ...
    =imaginal>
      result      =res
    !output!      ("remembered successfully")
)
